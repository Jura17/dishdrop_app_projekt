...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    name: 'Recipe',
    lastPropertyId: const obx_int.IdUid(14, 9160286232368477945),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(14, 9160286232368477945),
        name: 'lastUpdated',
        type: 10,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    ListItem: obx_int.EntityDefinition<ListItem>(
      model: _entities[1],
      toOneRelations: (ListItem object) => [object.recipe, object.shoppingList],
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final isShoppingListItemParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          12,
          false,
    ...
    Recipe: obx_int.EntityDefinition<Recipe>(
      ...
      toManyRelations: (Recipe object) => {
        obx_int.RelInfo<CookingDirection>.toOneBacklink(
          3,
          object.id,
        ...
        obx_int.RelInfo<ListItem>.toOneBacklink(
          7,
          object.id,
          (ListItem srcObject) => srcObject.recipe,
        ): object.ingredients,
      },
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final cookingTimeParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          20,
          0,
        ...
        final object =
            Recipe(
              ...
              ..timesCooked = const fb.Int64Reader().vTableGet(
                buffer,
                rootOffset,
                22,
                0,
    ...
    ShoppingList: obx_int.EntityDefinition<ShoppingList>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final isAllPurposeListParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          16,
          false,
...
class CookingDirection_ {
  ...
  static final id = obx.QueryIntegerProperty<CookingDirection>(
    _entities[0].properties[0],
  );

  /// See [CookingDirection.description].
  static final description = obx.QueryStringProperty<CookingDirection>(
...
class ListItem_ {
  /// See [ListItem.id].
  static final id = obx.QueryIntegerProperty<ListItem>(
    _entities[1].properties[0],
  );

  /// See [ListItem.description].
  static final description = obx.QueryStringProperty<ListItem>(
    _entities[1].properties[1],
  );

  /// See [ListItem.amount].
  static final amount = obx.QueryDoubleProperty<ListItem>(
    _entities[1].properties[2],
  );

  /// See [ListItem.unit].
  static final unit = obx.QueryStringProperty<ListItem>(
    _entities[1].properties[3],
  );

  /// See [ListItem.isShoppingListItem].
  static final isShoppingListItem = obx.QueryBooleanProperty<ListItem>(
    _entities[1].properties[4],
  );

  /// See [ListItem.isDone].
  static final isDone = obx.QueryBooleanProperty<ListItem>(
    _entities[1].properties[5],
  );

  /// See [ListItem.recipe].
  static final recipe = obx.QueryRelationToOne<ListItem, Recipe>(
...
class Recipe_ {
  ...
  /// See [Recipe.category].
  static final category = obx.QueryStringProperty<Recipe>(
  ...
  static final difficulty = obx.QueryStringProperty<Recipe>(
    _entities[2].properties[5],
  );

  /// See [Recipe.tags].
  static final tags = obx.QueryStringVectorProperty<Recipe>(
  ...
  static final cookingTime = obx.QueryIntegerProperty<Recipe>(
    _entities[2].properties[8],
  );

  /// See [Recipe.timesCooked].
  static final timesCooked = obx.QueryIntegerProperty<Recipe>(
    _entities[2].properties[9],
  );

  /// See [Recipe.isFavorite].
  static final isFavorite = obx.QueryBooleanProperty<Recipe>(
    _entities[2].properties[10],
  );

  /// See [Recipe.imagesJson].
  static final imagesJson = obx.QueryStringProperty<Recipe>(
    _entities[2].properties[11],
  );

  /// See [Recipe.shoppingList].
  static final shoppingList = obx.QueryRelationToOne<Recipe, ShoppingList>(
    _entities[2].properties[12],
  );

  /// See [Recipe.lastUpdated].
  static final lastUpdated = obx.QueryDateProperty<Recipe>(
  ...
  static final ingredients = obx.QueryBacklinkToMany<ListItem, Recipe>(
    ListItem_.recipe,
  );
}
...
class ShoppingList_ {
  ...
  static final title = obx.QueryStringProperty<ShoppingList>(
    _entities[3].properties[1],
  );

  /// See [ShoppingList.imgUrl].
  static final imgUrl = obx.QueryStringProperty<ShoppingList>(
    _entities[3].properties[2],
  );

  /// See [ShoppingList.servings].
  static final servings = obx.QueryIntegerProperty<ShoppingList>(
    _entities[3].properties[3],
  );

  /// See [ShoppingList.recipe].
  static final recipe = obx.QueryRelationToOne<ShoppingList, Recipe>(
    _entities[3].properties[4],
  );

  /// See [ShoppingList.isAllPurposeList].
  static final isAllPurposeList = obx.QueryBooleanProperty<ShoppingList>(
